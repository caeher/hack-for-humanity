...
>(({ className, ...props }, ref) => (
  <div
    ...
    tabIndex={0}
    className="relative w-full overflow-auto focus:outline-none focus-visible:ring-1 focus-visible:ring-ring rounded-md"
  >
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('bg-muted/50 text-xs font-mono uppercase text-muted-foreground [&_tr]:border-b', className)}
    {...props}
  />
))
